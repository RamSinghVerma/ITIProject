...
//        System.out.println(new NumberToWords().convert(Integer.parseInt(s)));
        System.out.println("*** " + obj.convert(120530));
//        System.out.println("*** " + obj.convert(-55));
        String s="123456782.89";
        System.out.println( new originalNumToLetter().convertAll("0.0"));
 ...
 public      String convertAll(double number){
    ...
    String s2=null;
     ...
     String  s1=convert(Integer.valueOf(s.substring(0,s.indexOf("."))));
        s2=s1;
       if(Integer.valueOf(s.substring(s.indexOf(".")+1))>0)
           s2=s1+" and "+convert(Integer.valueOf(s.substring(s.indexOf(".")+1)))+" Paise Only";
       }else
